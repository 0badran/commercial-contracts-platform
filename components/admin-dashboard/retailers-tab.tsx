...
export default function RetailersTab() {
  ...
  const handleAddRetailer = () => {
    ...
    console.log("Adding retailer:", newRetailer)
    setNewRetailer({
      name: "",
      ownerName: "",
      email: "",
        ...
        <Dialog open={isAddingRetailer} onOpenChange={setIsAddingRetailer}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" onClick={() => setIsAddingRetailer(false)}>
                إلغاء
              </Button>
            ...
            <TableBody>
              {filteredRetailers.map((retailer) => (
                <TableRow key={retailer.id}>
                  ...
                  <TableCell>
                    <Badge className="bg-green-100 text-green-800">{retailer.status}</Badge>
                  </TableCell>
                  <TableCell>
